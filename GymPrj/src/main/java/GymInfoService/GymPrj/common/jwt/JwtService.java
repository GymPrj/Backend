...
public class JwtService {
    ...
    private Key getSecretKey(){
        try {
            ...
            throw new GymPrjException(ErrorCode.JWT_ALGORITHM_NOT_FOUND);
        }
    }
    ...
    private boolean checkJwt(String token, long current){
        Jws<io.jsonwebtoken.Claims> claims = Jwts.parserBuilder()
    ...
    private String parseJwt(String token){
        ...
        try {
            ...
            throw new GymPrjException(ErrorCode.JSON_PROCESSING_ERROR);
        }
    }
}
